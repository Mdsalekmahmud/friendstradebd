                ...
                <div class="cat-items-wrap">
                    <div class="cat-item">
                        <a href="air-conditioner.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/ac-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="air-fryer.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/air-fryer-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="drone.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/drone-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="gimbal.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/gimbal-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="tablet-pc.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/tablet-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="television-startech.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/tv-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="trimmer.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/trimmer-48x48.png')); ?>"
                    ...
                    <div class="cat-item">
                        <a href="earbuds.html" class="cat-item-inner">
                            <span class="cat-icon"><img src="<?php echo e(asset('storage/images/category-thumb/earbuds-48x48.png')); ?>"
