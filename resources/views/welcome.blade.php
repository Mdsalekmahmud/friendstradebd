                    ...
                    <div class="cat-items-wrap">
                        <div class="cat-item">
                            <a href="air-conditioner.html" class="cat-item-inner">
                                <span class="cat-icon"><img
                                        src="{{ asset('storage/images/category-thumb/ac-48x48.png') }}" alt="AC Icon"
                        ...
                        <div class="cat-item">
                            <a href="television-startech.html" class="cat-item-inner">
                                <span class="cat-icon"><img
                                        src="{{ asset('storage/images/category-thumb/tv-48x48.png') }}" alt="TV Icon"
                                        width="48" height="48"></span>
                                <p>TV</p>
                            </a>
                        </div>
                        ...
                        @foreach ($products as $product)
                            <div class="p-item">
                                <div class="p-item-inner">
                                    ...
                                    <div class="p-item-img"> <a href="{{ route('productDetails', $product->id) }}">
