                ...
                <div class="pd-summary">
                    ...
                    <div class="p-opt-wrap">
                        <div class="p-opt required">
                            <div class="p-opt-lbl" id="input-option2831">Color: <b></b></div>
                            <div class="p-opt-vals">
                                <label><input class="hide" type="radio" value="112" name="option[2831]"
                                        title="Navy Blue"><span>Navy Blue</span></label>
                                <label><input class="hide" type="radio" value="137" name="option[2831]"
                    ...
                    <div class="cart-option">
                        <label class="quantity">
                            ...
                            <input type="hidden" name="product_id" value="45373">
                        </label>
